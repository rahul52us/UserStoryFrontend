...
import { Avatar, Box, Card, Flex, Heading, IconButton, Image, Text } from "@chakra-ui/react";
...
const CategoryCard = ({ image, title, description, username, userPic, discountPrice, originalPrice, rating, totalCount } : any) => {
  ...
  return (
    ...
    >
      <Image src={image} alt="" borderRadius={5} height="100%" width="100%" objectFit="contain" maxH={{ md: '320', lg : 220}} />
