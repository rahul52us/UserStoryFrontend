...
const DashboardIndex = observer(() => {
  ...
  const headers =
    ...
    const columns = [
      { field: "name", title: "Name", sortable: true, filterable: true, action : (data : any) => console.log(data) },
      { field: "age", title: "Age", sortable: true, filterable: true, link:true },
      { field: "role", title: "Role", sortable: true, filterable: true, badge : true, badgeColor:'red', link : true, tooltip:true },
    ];
